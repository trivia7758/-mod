...
namespace CaoCao.Camp
{
    ...
    public class CampManager : MonoBehaviour
    {
        ...
        void HideAllScreens()
        {
            ...
            if (_shopPanelGo != null) _shopPanelGo.SetActive(false);
        }
        ...
        void BuildAllScreens()
        {
            ...
            // Shop screen
            _shopPanelGo = CreateScreenPanel("ShopScreen");
            _shopScreen = _shopPanelGo.AddComponent<CampShopScreen>();
            _shopScreen.Build(_gsm, _registry);
            _shopScreen.OnBack += ReturnToMenu;
        ...
        static readonly Color DeployCardBg = new(0f, 0f, 0f, 0.8f);
        static readonly Color DeployCardSelectedBg = new(0.25f, 0.2f, 0.1f, 0.9f);
        ...
        void CreateHeroCard(RectTransform parent, HeroRuntimeData hero, HeroDefinition heroDef, bool isRequired)
        {
            ...
            bool initiallySelected = isRequired || _selectedHeroes.Contains(hero.heroId);
            cardImg.color = initiallySelected ? DeployCardSelectedBg : DeployCardBg;
        ...
        void UpdateDeployVisuals(string heroId)
        {
            ...
            {
                bool selected = _selectedHeroes.Contains(heroId);

                // Update border
                var outline = cardImg.GetComponent<Outline>();
                if (outline != null)
                    outline.effectColor = selected ? DeploySelectedBorder : DeployNormalBorder;

                // Update background color directly (transition is None)
                cardImg.color = selected ? DeployCardSelectedBg : DeployCardBg;
            }
        }
        ...
        void OnDeployConfirmed()
        {
            ...
            if (_gsm != null)
            {
                ...
                // Set the battle ID so BattleController can find the BattleDefinition
                _gsm.State.currentBattleId = "Battle_01";
            ...
            Debug.Log($"[CampManager] Loading battle scene: {sceneName}, battleId=Battle_01, deployed={_selectedHeroes.Count} heroes");
        ...
        void HideCamp()
        {
            ...
            // Destroy all UI so it's rebuilt fresh on return
            if (_canvas != null)
            {
            ...
            _heroPanelGo = null;
            _equipPanelGo = null;
            _warehousePanelGo = null;
            _systemPanelGo = null;
            _shopPanelGo = null;
            _heroScreen = null;
            _equipScreen = null;
            _warehouseScreen = null;
            _systemScreen = null;
            _shopScreen = null;
        }
